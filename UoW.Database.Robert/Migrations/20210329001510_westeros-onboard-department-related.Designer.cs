...
namespace UoW.Database.Robert.Migrations
{
    ...
    [Migration("20210329001510_westeros-onboard-department-related")]
    partial class westerosonboarddepartmentrelated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UoW.Database.Robert.Entities.CourseSyllabus", b =>
                {
                    ...
                    b.Property<int>("CourseModuleTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CourseModuleTypeId");

                    b.HasIndex("Title", "CourseId", "CourseModuleTypeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("UoW.Database.Robert.Entities.DepartmentCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("DepartmentId", "CourseId", "SemesterId")
                        .IsUnique();

                    b.ToTable("DepartmentCourses");
                });

            modelBuilder.Entity("UoW.Database.Robert.Entities.DepartmentCourseModule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("DepartmentCourseId", "CourseModuleTypeId")
                        .IsUnique();

                    b.ToTable("DepartmentCourseModules");
                });

            modelBuilder.Entity("UoW.Database.Robert.Entities.DepartmentFaculty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UoW.Database.Robert.Entities.CourseSyllabus", b =>
                {
                    ...
                    b.HasOne("UoW.Database.Robert.Entities.CourseModuleType", "CourseModuleType")
                        .WithMany("CourseSyllabi")
                        .HasForeignKey("CourseModuleTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("UoW.Database.Robert.Entities.DepartmentCourseModule", b =>
                {
                    b.HasOne("UoW.Database.Robert.Entities.CourseModuleType", "CourseModuleType")
                        .WithMany("DepartmentCourseModules")
                        .HasForeignKey("CourseModuleTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UoW.Database.Robert.Entities.DepartmentCourse", "DepartmentCourse")
                        .WithMany("DepartmentCourseModules")
